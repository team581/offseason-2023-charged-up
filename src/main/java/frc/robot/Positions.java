...
public class Positions {
  ...
  public static final SuperstructurePosition STOWED_UNSAFE =
      Config.IS_SPIKE
          ? new SuperstructurePosition(0.1, Rotation2d.fromDegrees(2), -1, true)
  ...
  public static final SuperstructurePosition INTAKING_CUBE_FLOOR =
      Config.IS_SPIKE
          ? new SuperstructurePosition(1, Rotation2d.fromDegrees(72.5), -1, true)
  ...
  public static final SuperstructurePosition INTAKING_CONE_FLOOR =
      Config.IS_SPIKE
          ? new SuperstructurePosition(5, Rotation2d.fromDegrees(92), -1, true)
  ...
  public static final SuperstructurePosition INTAKING_CONE_SHELF =
      Config.IS_SPIKE
          ? new SuperstructurePosition(26.9, Rotation2d.fromDegrees(92), -1)
  ...
  public static final SuperstructurePosition CONE_NODE_LOW =
      Config.IS_SPIKE
          ? new SuperstructurePosition(0, Rotation2d.fromDegrees(65), -1, true)
          : new SuperstructurePosition(0.5, Rotation2d.fromDegrees(145), -1);
  public static final SuperstructurePosition CONE_NODE_MID =
      Config.IS_SPIKE
          ? new SuperstructurePosition(12.75, Rotation2d.fromDegrees(52), -1)
          : new SuperstructurePosition(25, Rotation2d.fromDegrees(175), -1);
  public static final SuperstructurePosition CONE_NODE_HIGH =
      Config.IS_SPIKE
          ? new SuperstructurePosition(26.3, Rotation2d.fromDegrees(72), -1)
