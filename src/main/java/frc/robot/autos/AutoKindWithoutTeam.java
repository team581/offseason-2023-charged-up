...
public enum AutoKindWithoutTeam {
  ...
  MID_1_5_BALANCE(AutoKind.BLUE_MID_2_BALANCE, AutoKind.BLUE_MID_2_BALANCE),
  MID_2_BALANCE(AutoKind.BLUE_MID_2_BALANCE, AutoKind.RED_MID_2_BALANCE),
  MID_2_BALANCE_TEST(AutoKind.BLUE_MID_2_BALANCE_TEST, AutoKind.BLUE_MID_2_BALANCE_TEST),
  ...
  LONG_SIDE_3_WARN(AutoKind.RED_LONG_SIDE_3, AutoKind.BLUE_LONG_SIDE_3_WORN);
