...
public enum AutoKindWithoutTeam {
  ...
  // MID_RIGHT_2_BALANCE_WORN(AutoKind.RED_MID_RIGHT_2_BALANCE_WORN, AutoKind.BLUE_MID_RIGHT_2_BALANCE_WORN),
  // MID_LEFT_2_BALANCE_WORN(AutoKind.RED_MID_LEFT_2_BALANCE_WORN, AutoKind.BLUE_MID_LEFT_2_BALANCE_WORN),
