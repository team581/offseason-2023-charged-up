...
public class Config {
  ...
  public static final double ELEVATOR_MAX_HEIGHT = IS_SPIKE ? 26.4 : 12;
  ...
  public static final double ELEVATOR_KS = IS_SPIKE ? 0 : 0;
  ...
  public static final Rotation2d WRIST_HOMED_ANGLE =
      IS_SPIKE ? Rotation2d.fromDegrees(-1) : Rotation2d.fromDegrees(0.0);
